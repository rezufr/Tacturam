    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                // Override RGB color with _HoverColor, using _HoverProgress to blend
                // Keep original texture alpha so texture shape stays identical
                color.rgb = lerp(color.rgb, _HoverColor.rgb, _HoverProgress);
